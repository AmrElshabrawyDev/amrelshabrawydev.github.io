...
export function HeroSection() {
  return (
    <section className="container-custom min-h-[calc(100vh-8rem)] relative overflow-hidden bg-bg-base py-20">
      <div className="mb-8 w-full flex justify-start animate-fade-in-left [animation-delay:100ms] opacity-0">
        <PowerlineGroup>
      ...
      <div className="relative z-10 flex flex-col-reverse lg:grid lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="w-full flex flex-col items-center lg:items-start text-center lg:text-left">
          ...
          {/* Powerline Roles Row */}
          <div className="mb-8 w-full flex justify-start animate-fade-in-left [animation-delay:300ms] opacity-0">
            <PowerlineGroup>
              <PowerlineSegment
                color="info"
          ...
          {/* Description Block */}
          <div className="text-text-secondary text-base text-left md:text-lg max-w-xl mb-12 leading-relaxed font-mono border border-border-subtle p-6 bg-bg-elevated relative overflow-hidden animate-fade-in-up [animation-delay:400ms] opacity-0">
          ...
          {/* CTAs as Segments */}
          <div className="flex flex-wrap items-center justify-center lg:justify-start gap-8 animate-fade-in-up [animation-delay:500ms] opacity-0">
            <PowerlineGroup>
              <Link href="/work">
                <PowerlineSegment
                  color="primary"
